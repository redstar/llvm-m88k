...
; CHECK-NEXT:    st %r2, %r31, 0 | 4-byte Folded Spill
; CHECK-NEXT:    or %r2, %r0, %r3
; CHECK-NEXT:    ld %r3, %r31, 0 | 4-byte Folded Reload
; CHECK-NEXT:    st %r2, %r31, 4 | 4-byte Folded Spill
; CHECK-NEXT:    subu %r2, %r4, 1
; CHECK-NEXT:    st %r2, %r31, 8 | 4-byte Folded Spill
; CHECK-NEXT:    cmp %r2, %r2, 5
; CHECK-NEXT:    st %r3, %r31, 12 | 4-byte Folded Spill
; CHECK-NEXT:    bb1 8, %r2, .LBB0_8
; CHECK-NEXT:  | %bb.1: | %entry
; CHECK-NEXT:    ld %r3, %r31, 8 | 4-byte Folded Reload
; CHECK-NEXT:    or.u %r2, %r0, %hi16(.LJTI0_0)
; CHECK-NEXT:    or %r2, %r2, %lo16(.LJTI0_0)
; CHECK-NEXT:    ld %r2, %r2[%r3]
; CHECK-NEXT:    jmp %r2
; CHECK-NEXT:  .LBB0_2: | %b.add
; CHECK-NEXT:    ld %r2, %r31, 0 | 4-byte Folded Reload
; CHECK-NEXT:    ld %r3, %r31, 4 | 4-byte Folded Reload
; CHECK-NEXT:    addu %r2, %r2, %r3
; CHECK-NEXT:    st %r2, %r31, 12 | 4-byte Folded Spill
...
; CHECK-NEXT:    ld %r2, %r31, 12 | 4-byte Folded Reload
