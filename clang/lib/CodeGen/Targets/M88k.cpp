...
namespace {
class M88kABIInfo final : public DefaultABIInfo {
...
llvm::dbgs() << "M88kABIInfo::EmitVAArg\n";
  ...
  Address VaRegPtr = CGF.Builder.CreateStructGEP(VAListAddr, 2, "__va_reg_ptr");
  Address VaReg = Address(CGF.Builder.CreateLoad(VaRegPtr, "__va_reg"),
                          CGF.Int8Ty, PtrAlign);
  CGF.Builder.CreateBr(ContBlock);

  CGF.EmitBlock(InStkBlock);
  Address VaStkPtr = CGF.Builder.CreateStructGEP(VAListAddr, 1, "__va_stk_ptr");
  ...
  llvm::Value *NewVaArg = CGF.Builder.CreateAdd(VaArg, One, "__va_arg_plus_1");
